  ...
  // â”€â”€ SHAP Feature bars â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  function buildFeatureBars(shap) {
    ...
    div.innerHTML = `
      <div class="card-title">
        <div class="icon" style="background:rgba(59,130,246,0.15);">ðŸ”</div>
        Top Risk Factors
      </div>
      ${bars}
    `;
  ...
  // â”€â”€ SMS Action Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    btn.onclick = async () => {
      ...
      try {
        ...
        if (json.alert_triggered || json.message) {
          status.textContent = 'âœ… SMS Drafted: ' + json.message + (json.sms_response && json.sms_response.error ? ' (API Error: '+json.sms_response.error+')' : '');
          status.style.color = json.sms_response && json.sms_response.error ? 'var(--orange)' : 'var(--green)';
        } else if (json.error) {
          status.textContent = 'âŒ ' + json.error;
          status.style.color = 'var(--red)';
        } else {
          status.textContent = 'âŒ Failed to send SMS. Risk may not meet threshold.';
          status.style.color = 'var(--red)';
        }
      } catch(e) {
        status.textContent = 'âŒ Network error.';
        status.style.color = 'var(--red)';
      } finally {
        btn.disabled = false;
